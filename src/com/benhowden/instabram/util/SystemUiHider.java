 ...
 * {@link #getInstance} will return a {@link SystemUiHiderImpl} instance,
...
public abstract class SystemUiHider {
     ...
     * {@link SystemUiHiderBase} or {@link SystemUiHiderImpl} depending on
     * the device.
     * 
    ...
    public static SystemUiHider getInstance(Activity activity, View anchorView, int flags) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            return new SystemUiHiderImpl(activity, anchorView, flags);
        } else {
